...
{    public static class DataMocker
    {
        ...
        public static void InsertMockData(DataContext context)
        {
            ...
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (830229420358, '$7.70', 'ES', 'turpis nec euismod scelerisque quam turpis adipiscing lorem', 27, 1, 1)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (773041838566, '$5.80', 'Vandura G2500', 'est et tempus semper est quam pharetra magna ac consequat', 77, 0, 2)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (179540114473, '$5.18', 'Capri', 'elit proin interdum mauris non ligula pellentesque', 19, 1, 3)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (864103424538, '$0.30', 'RX', 'elementum nullam varius nulla facilisi cras', 67, 0, 4)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (786514865205, '$5.47', 'Mazda3', 'blandit ultrices enim lorem ipsum dolor sit amet', 23, 0, 5)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (901889382624, '$8.91', 'Mustang', 'ultrices libero non mattis pulvinar nulla pede', 55, 0, 6)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (376682463464, '$9.40', 'Vibe', 'nonummy integer non velit donec diam neque', 13, 0, 7)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (653681550128, '$6.11', 'Ram Wagon B350', 'eget nunc donec quis orci', 94, 1, 8)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (733723714897, '$1.14', 'SSR', 'posuere cubilia curae donec pharetra magna vestibulum aliquet', 41, 1, 9)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (282889232704, '$7.03', 'Leaf', 'in magna bibendum imperdiet nullam orci pede venenatis non', 17, 1, 10)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (181070346951, '$3.17', 'Express 2500', 'mi sit amet lobortis sapien sapien non mi', 26, 0, 11)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (256071266151, '$2.82', 'Probe', 'ipsum primis in faucibus orci luctus et ultrices', 87, 1, 12)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (310235256602, '$0.44', 'Elantra', 'neque sapien placerat ante nulla justo', 64, 1, 13)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (761775648747, '$5.60', 'Capri', 'nisi volutpat eleifend donec ut dolor morbi vel', 43, 1, 14)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (517848276781, '$3.36', 'M', 'neque duis bibendum morbi non quam', 24, 0, 15)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (674826245513, '$7.48', 'Grand Prix', 'nulla ut erat id mauris', 24, 0, 16)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (191511818615, '$1.93', 'Mustang', 'tempus sit amet sem fusce consequat', 17, 1, 17)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (294142120997, '$0.39', 'Accord', 'pharetra magna ac consequat metus sapien', 27, 1, 18)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (492161487402, '$5.10', 'XC70', 'mauris vulputate elementum nullam varius', 87, 1, 19)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (256631482515, '$7.97', 'Boxster', 'eros viverra eget congue eget', 82, 0, 20)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID) values (913042410011, '$1.19', 'Savana 2500', 'consequat in consequat ut nulla', 68, 1, 21)");
