...
{    public static class DataMocker
    {
        ...
        public static void InsertMockData(DataContext context)
        {
            ...
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Portugal', 'Florida', '33731', 'Saint Petersburg', 'Main', 331, 0, 1)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Cameroon', 'Alabama', '35290', 'Birmingham', 'Raven', 332, 0, 2)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('China', 'Ohio', '45254', 'Cincinnati', 'Hanson', 127, 0, 3)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Ireland', 'Michigan', '48901', 'Lansing', 'Fieldstone', 230, 0, 4)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Kazakhstan', 'New York', '10105', 'New York City', 'Nobel', 204, 0, 5)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Yemen', 'Texas', '77030', 'Houston', 'Montana', 328, 1, 6)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Ukraine', 'Tennessee', '38109', 'Memphis', 'Heath', 117, 1, 7)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Botswana', 'California', '95160', 'San Jose', 'Crowley', 152, 1, 8)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Colombia', 'California', '92153', 'San Diego', 'Warrior', 102, 0, 9)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Japan', 'Texas', '77271', 'Houston', 'Hoard', 226, 1, 10)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Indonesia', 'Michigan', '49518', 'Grand Rapids', 'Sloan', 260, 1, 11)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Bulgaria', 'Texas', '79105', 'Amarillo', 'Paget', 261, 0, 12)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Portugal', 'Florida', '32520', 'Pensacola', 'Division', 245, 1, 13)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Indonesia', 'New Mexico', '87592', 'Santa Fe', 'Bartillon', 331, 1, 14)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('China', 'Florida', '33147', 'Miami', 'Park Meadow', 243, 0, 15)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Poland', 'Illinois', '62705', 'Springfield', 'Paget', 284, 0, 16)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Indonesia', 'Texas', '76505', 'Temple', 'Brentwood', 140, 1, 17)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('China', 'Illinois', '60630', 'Chicago', 'Pawling', 330, 1, 18)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('China', 'Connecticut', '06145', 'Hartford', 'Park Meadow', 297, 1, 19)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Indonesia', 'Texas', '76192', 'Fort Worth', 'Oneill', 156, 0, 20)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Iraq', 'North Carolina', '27404', 'Greensboro', 'Manley', 348, 1, 21)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Portugal', 'Missouri', '63121', 'Saint Louis', 'Lukken', 221, 0, 22)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Indonesia', 'Florida', '33283', 'Miami', 'Lerdahl', 349, 0, 23)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('China', 'Texas', '76310', 'Wichita Falls', 'Thierer', 256, 0, 24)");
            context.Database.ExecuteSqlCommand("insert into Addresses (Country, State, ZipCode, City, Street, AptNum, DefaultAddress, AddressCustID) values ('Greece', 'Iowa', '52405', 'Cedar Rapids', 'Drewry', 332, 0, 25)");
