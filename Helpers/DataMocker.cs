...
{    public static class DataMocker
    {
        ...
        public static void InsertMockData(DataContext context)
        {
            ...
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Salem', 'Britten', 'Crona and Sons', 18, '(202)-933-4985', 'vhanning2@berkeley.edu', 3, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Herold', 'Lukovic', 'Wolf-Rau', 20, '(843)-110-4438', 'lhullins3@pbs.org', 9, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Luisa', 'Plaice', 'Schoen-Larson', 24, '(363)-190-0562', 'tposer4@washingtonpost.com', 19, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Alina', 'Powland', 'Skiles-Bailey, 5, '(464)-619-8891', 'jdudson5@huffingtonpost.com', 8, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Ulysses', 'Gallego', 'Bartoletti-Wisozk', 6, '(037)-828-4559', 'nellul6@icio.us', 5, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Dani', 'Kyberd', 'Kub, Grady and O''Reilly', 17, '(314)-920-6435', 'fgorvin7@yelp.com', 11, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Dario', 'Bompass', 'Parisian-Wolf', 4, '(671)-159-7740', 'ogolagley8@live.com', 3, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Sabina', 'Boule', 'Ward-Emard', 23, '(485)-389-7221', 'aajam9@com.com', 22, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Kristina', 'Klemps', 'Ullrich-Borer', 19, '(273)-815-5707', 'spattena@themeforest.net', 12, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Hortense', 'Georgeson', 'Lowe-Casper', 21, '(922)-932-0576', 'kdennidgeb@clickbank.net', 16, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Darn', 'Endon', 'Kunde LLC', 25, '(900)-577-3446', 'xcribbinc@answers.com', 25, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Deb', 'Strettell', 'Medhurst-Cruickshank', 10, '(311)-514-9734', 'sbeadesd@google.es', 11, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Karylin', 'D'Adamo', 'Stehr, Doyle and Olson', 22, '(398)-455-5984', 'qclemase@amazon.co.uk', 14, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Stacy', 'Jencey', 'Balistreri LLC', 3, '(611)-308-4835', 'gsighartf@indiegogo.com', 16, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Hollis', 'Cousans', 'Greenfelder and Sons', 13, '(360)-051-3161', 'idellortog@ibm.com', 42, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Sim', 'Josefowicz', 'Howe Inc', 2, '(206)-327-3396', 'dnegush@deviantart.com', 15, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Elene', 'Kantor', 'Blick-Smitham', 11, '(732)-565-7755', 'gchateli@engadget.com', 5, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Roarke', 'Sneddon', 'Sawayn, Moen and Bahringer', 14, '(353)-555-7988', 'rbrucksteinj@instagram.com', 19, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Kata', 'Brimble', 'Hayes, Nikolaus and Hettinger', 1, '(647)-264-4568', 'abangiardk@quantcast.com', 2, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Darrell', 'Lidgely', 'Dooley Inc', 3, '(123)-123-1836', 'cephgravel@feedburner.com', 1, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Rowena', 'Willmore', 'Brakus Inc', 8, '(361)-840-0389', 'ftollerfieldm@php.net', 20, 1)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Barbabas', 'Cranham', 'Gibson Group', 9, '(985)-309-7957', 'jgodlipn@youku.com', 22, 0)");
            context.Database.ExecuteSqlCommand("insert into Customers (FirstName, LastName, CompanyName, CustInvoiceID, PhoneNumber, Email, CustAddressID, IsCompany) values ('Cristy', 'Shattock', 'Ebert-Gibson', 12, '(195)-407-1559', 'cstokeyo@wisc.edu', 23, 1)");

            //insert mock data into the inventories table        
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (302, '$7.20', 'Breadfruit', 'Xxpeizrxehxzbp', 23, 0, 12, 3, 23)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (383, '$5.06', '('Cake - Pancake', 'Whlmunkkrgulka', 80, 1, 5, 11, 13)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (851, '$8.92', 'Foam Espresso Cup Plain White', 'Yakcsuztgrhucy', 5, 1, 18, 2, 17)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (717, '$5.25', 'Bread Base - Goodhearth', 'Ffyrbbfwazmhie', 80, 0, 4, 23, 14)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (80, '$9.28', 'Container - Clear 32 Oz', 'Zikwyacivrgfgo', 74, 0, 15, 23, 13)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (371, '$4.77', 'Coffee - 10oz Cup 92961', 'Zkrixvzjcqoyrs', 34, 0, 7, 4, 1)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (953, '$9.68', 'Broom Handle', 'Hdvwbptnassrqg', 38, 1, 18, 25, 25)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (107, '$4.44', 'Oil - Cooking Spray', 'Nyuvyebslheadr', 37, 1, 12, 20, 4)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (832, '$6.42', 'Chinese Foods - Chicken Wing', 'Abxkkebvzgejnz', 40, 1, 9, 12, 10)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (217, '$7.76', 'Beans - Navy, Dry', 'Oadfewhnnzilnk', 38, 0, 24, 15, 18)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (508, '$2.10', 'Chicken - Base', 'Djobfpjezbnrmn', 58, 0, 19, 8, 18)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (233, '$9.33', 'Lamb Leg - Bone - In Nz', 'Vbcajwsiufmpbf', 15, 1, 20, 21, 22)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (175, '$5.21', 'Mushroom - Shitake, Fresh', 'Ptsbphuqzndbkc', 36, 1, 1, 3, 16)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (800, '$2.67', 'Crackers - Soda / Saltins', 'Sngflaidsejvsk', 88, 0, 5, 2, 10)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (11, '$1.40', 'Kolrabi', 'Igikovsdqekhyy', 1, 1, 25, 5, 9)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (465, '$3.80', 'Cheese - Woolwich Goat, Log', 'Pteewkvzyvvcox', 72, 1, 25, 20, 8)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$5.72', 'Amaretto', 'Gcfnrkiirsfpqu', 83, 1, 5, 9, 10)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (143, '$1.55', 'Wine - White, Riesling, Semi - Dry', 'Qcjdtqbpecvgvl', 52, 0, 1, 6, 8)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$4.46', 'Scallops 60/80 Iqf', 'Mddbjdrhyutxip', 90, 1, 9, 17, 21)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (106, '$0.05', 'Bread Base - Toscano', 'Gpposwmrdmvqcy', 95, 1, 9, 20, 8)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (967, '$3.49', 'Beer - Mcauslan Apricot', 'Fahlahxvmrcamn', 83, 0, 23, 15, 24)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (925, '$3.95', 'Crab - Imitation Flakes', 'Xftfkslzmypdzd', 24, 0, 15, 13, 11)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (955, '$8.76', 'Quail Eggs - Canned', 'Fuvrtifnzfflol', 13, 1, 8, 1, 9)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$3.89', 'Tomatoes - Vine Ripe, Red', 'Pwoyirpprbtljd', 21, 1, 13, 23, 21)");
            context.Database.ExecuteSqlCommand("insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (127, '$6.11', 'Longos - Chicken Cordon Bleu', 'Qjlghkhyfeflnu', 95, 1, 24, 18, 18)");
            ...
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('01/26/2019', 1, 0, '$3.42')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('10/11/2018', 0, 1, '$0.89')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('02/06/2019', 1, 0, '$4.94')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('03/21/2018', 1, 0, '$1.70')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('09/16/2018', 0, 1, '$5.30')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('05/31/2018', 0, 1, '$2.68')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('01/28/2018', 0, 1, '$6.70')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('08/30/2018', 0, 1, '$1.24')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('12/22/2018', 1, 0, '$5.39')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('04/28/2018', 0, 1, '$3.71')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('07/20/2018', 0, 1, '$7.06')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('01/24/2018', 1, 0, '$3.77')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('04/26/2018', 1, 0, '$9.78')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('05/15/2018', 0, 1, '$0.02')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('03/23/2018', 0, 1, '$1.93')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('09/01/2018', 1, 0, '$8.12')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('02/15/2018', 0, 1, '$6.50')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('02/15/2018', 0, 1, '$1.58')");
            context.Database.ExecuteSqlCommand("insert into Invoices ( InvoiceDate, OutgoingInv, IncomingInv, AmountPaid) values ('06/27/2018', 1, 0, '$6.64')");
