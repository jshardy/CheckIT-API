...
{    public static class DataMocker
    {
        ...
        public static void InsertMockData(DataContext context)
        {
            ...
            context.Database.ExecuteSqlCommand(
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (11, 86, '03/22/2018', '08/16/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (15, 57, '07/01/2018', '09/07/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (24, 90, '01/12/2018', '05/22/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (3, 11, '02/15/2018', '04/20/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (18, 84, '12/08/2018', '09/13/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (20, 21, '07/17/2018', '12/17/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (18, 73, '01/26/2018', '10/19/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (21, 43, '10/02/2018', '11/25/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (19, 62, '04/18/2018', '07/10/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (5, 19, '01/08/2019', '12/21/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (6, 60, '01/20/2018', '05/19/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (5, 70, '01/21/2019', '01/09/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (23, 92, '01/20/2018', '03/28/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (11, 100, '03/27/2018', '01/25/2019', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (1, 65, '03/03/2018', '08/20/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (14, 37, '03/27/2018', '05/10/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (22, 78, '06/26/2018', '07/26/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (18, 80, '02/03/2019', '12/15/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (22, 10, '01/22/2018', '07/03/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (21, 75, '07/26/2018', '09/07/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (24, 59, '06/19/2018', '05/03/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (19, 67, '01/10/2019', '01/25/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (8, 11, '01/19/2019', '12/17/2018', 0)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (14, 93, '01/16/2018', '10/14/2018', 1)",
                "insert into Alerts (InventoryId, Threshold, DateUnder, DateOrdered, AlertOn) values (23, 66, '08/27/2018', '03/30/2018', 1)"
            );
            ...
            context.Database.ExecuteSqlCommand(
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (302, '$7.20', 'Scdxrexmdrmdq', 'Xxpeizrxehxzbp', 23, 0, 6, 11, 98)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (383, '$5.06', 'Unwwzjctramkh', 'Whlmunkkrgulka', 82, 1, 56, 66, 64)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (851, '$8.92', 'Jvfprnankrcme', 'Yakcsuztgrhucy', 48, 1, 80, 43, 80)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (717, '$5.25', 'Thtsgntddbfio', 'Ffyrbbfwazmhie', 80, 0, 68, 62, 5)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (80, '$9.28', 'Iepbuqnlndhvp', 'Zikwyacivrgfgo', 74, 0, 69, 24, 70)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (371, '$4.77', 'Hwzdtnytuwcmr', 'Zkrixvzjcqoyrs', 34, 0, 85, 87, 14)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (953, '$9.68', 'Fdnchbfhdswyd', 'Hdvwbptnassrqg', 38, 1, 51, 27, 43)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (107, '$4.44', 'Trnvhzeszktyq', 'Nyuvyebslheadr', 37, 1, 31, 47, 1)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (832, '$6.42', 'Uohlsvjiatxgb', 'Abxkkebvzgejnz', 40, 1, 48, 74, 90)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (217, '$7.76', 'Usttuzeklmjcw', 'Oadfewhnnzilnk', 38, 0, 84, 31, 60)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (508, '$2.10', 'Alminrewrcyhb', 'Djobfpjezbnrmn', 58, 0, 15, 80, 45)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (233, '$9.33', 'Wfcarxthmgobw', 'Vbcajwsiufmpbf', 15, 1, 72, 24, 32)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (175, '$5.21', 'Rtylgvopbhuki', 'Ptsbphuqzndbkc', 36, 1, 58, 76, 94)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (800, '$2.67', 'Mzjisiuuhkydi', 'Sngflaidsejvsk', 88, 0, 62, 30, 83)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (11, '$1.40', 'Twzvrpmuyivkx', 'Igikovsdqekhyy', 1, 1, 72, 76, 55)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (465, '$3.80', 'Xlpldnpxxxtuz', 'Pteewkvzyvvcox', 72, 1, 32, 54, 11)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$5.72', 'Askfytnrsjyki', 'Gcfnrkiirsfpqu', 83, 1, 74, 50, 20)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (143, '$1.55', 'Nsxhrhivnoiqf', 'Qcjdtqbpecvgvl', 52, 0, 63, 7, 37)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$4.46', 'Eotwvqlqabcuh', 'Mddbjdrhyutxip', 90, 1, 85, 62, 1)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (106, '$0.05', 'Hwlwrgyivlblw', 'Gpposwmrdmvqcy', 95, 1, 51, 17, 31)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (967, '$3.49', 'Aqjolchecvgfw', 'Fahlahxvmrcamn', 83, 0, 69, 92, 70)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (925, '$3.95', 'Meucfcvvsfbpv', 'Xftfkslzmypdzd', 24, 0, 91, 81, 31)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (955, '$8.76', 'Uftqkwsoxkshg', 'Fuvrtifnzfflol', 13, 1, 88, 75, 73)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (687, '$3.89', 'Rrnnstkunmstl', 'Pwoyirpprbtljd', 21, 1, 89, 45, 2)",
                "insert into Inventories (UPC, Price, Name, Description, Quantity, Archived, InventoryLocationID, InventoryAlertID, LineItemID) values (127, '$6.11', 'Qqbrefedulteo', 'Qjlghkhyfeflnu', 95, 1, 92, 79, 97)"
            );
